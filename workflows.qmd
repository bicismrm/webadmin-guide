...
2. Save a copy of the cover image offline. Rename the image file using the following convention:  
   ...
   The following snippet may be useful to serve as a template for this workflow:
   ```
Image x
mr-education-{YYYY}-{MM}-{DD}-cover
...
he primary liaison for maintaining this section is the **recipient of the New Initiative & Public Engagement Fund**.
